...
namespace ApplyBonusScores
{
    class ApplyBonusScores
    {
        static void Main(string[] args)
        {
            ...
            // if it is between 4 and 6, multiplies it by 100; if it is between 7 and 9, multiplies it by
            // 1000. If it is zero or if the value is not a digit, the program must report an error.
